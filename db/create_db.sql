...
While he became well regarded in the fantasy and science fiction worlds, Martin had yet to achieve a huge commercial success by the 1980s. He did, however, attract some attention from Hollywood. He worked as story editor for a remake of the old favorite Twilight Zone in 1986, and then became involved with the series Beauty and the Beast. Writing for television posed certain challenges for Martin. Whenever I would turn in a script, the producers would always say to me: George, this is wonderful, but it would cost five times our budget to produce it, he said in a National Public Radio interview. Weary of the limitations of television, Martin embarked on a new writing project in the early 1990s—a fantasy series inspired by medieval Englands Wars of the Roses.
